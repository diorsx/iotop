...
print_help(void)
{
    printf(
        ...
        "  -w NUM, --wbytes=NUM  only show processes that wbps than the special num (implies --batch)\n"
        "  -r NUM, --rbytes=NUM  only show processes that rbps than the special num (implies --batch)\n"
